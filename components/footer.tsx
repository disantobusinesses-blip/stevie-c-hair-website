      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-6 mb-12">
            ...
            <Link
              href="https://www.facebook.com/steviec.hair/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-primary transition-colors duration-300"
          ...
          {/* Quick Links */}
          <div className="flex flex-wrap justify-center gap-8 mb-12 text-sm tracking-widest uppercase">
            <Link href="/" className="text-white/60 hover:text-primary transition-colors duration-300">
              Home
            </Link>
            <Link href="/services" className="text-white/60 hover:text-primary transition-colors duration-300">
              Services
            </Link>
            <Link href="/careers" className="text-white/60 hover:text-primary transition-colors duration-300">
              Careers
            </Link>
            <Link
          ...
          <p className="text-white/40 text-xs tracking-wider">
            © {new Date().getFullYear()} Stevie C Hair. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
